...
![ROC and precision-recall curves of the P10N10 test dataset, drawn side
by
side](https://raw.githubusercontent.com/evalclass/precrec/main/README_files/figure-gfm/unnamed-chunk-2-1.png)
...
- [Get
  ...
  [`vignette("introduction", package = "precrec")`](https://evalclass.github.io/precrec/articles/introduction.md).
...
- [Reference](https://evalclass.github.io/precrec/reference/) – the help
  ...
  [`help(package = "precrec")`](https://evalclass.github.io/precrec/reference).
...
| `best_cutoff` | Pick the cutoff that optimizes one evaluation metric |
