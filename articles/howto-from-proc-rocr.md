...
| `levels =` | `posclass =` | Which label is the positive one |
| `direction =` | Negate the scores | See [which direction the score runs](https://evalclass.github.io/precrec/articles/howto-prepare-data.html#which-direction-the-score-runs) |
