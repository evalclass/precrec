...
test_that("create_curves() reterns a correct ROC curve", {
  ...
  expect_equal(curves[["roc"]][["x"]], c(0, 0.1, 0.2, 0.3, 1 / 3, 1 / 3,
                                         0.4, 0.5, 0.6, 2 / 3, 2 / 3,
                                         0.7, 0.8, 0.9, 1, 1))
  expect_equal(curves[["roc"]][["y"]], c(0, 0, 0, 0, 0, 1 / 3, 1 / 3,
                                         1 / 3, 1 / 3,
                                         1 / 3, 2 / 3, 2 / 3, 2 / 3, 2 / 3,
                                         2 / 3, 1))
...
test_that("create_curves() reterns correct a precision-recall curve", {
  ...
  expect_equal(curves[["prc"]][["y"]], c(0, 0.230769, 0.375, 0.473684, 0.5,
                                            ...
                                            0.473684, 0.5),
               tolerance = 1e-4)
  expect_equal(curves[["prc"]][["orig_points"]], c(TRUE, FALSE, FALSE, FALSE,
                                                   TRUE, TRUE, FALSE, FALSE,
                                                   FALSE, TRUE, TRUE, FALSE,
                                                   FALSE, FALSE, TRUE))
})
