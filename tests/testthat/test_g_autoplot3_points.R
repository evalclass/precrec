...
ap3_test_basic_measures <- function(curves, ptitle, check_def_matrix = FALSE,
  ...
  vdiffr::expect_doppelganger(paste0(ptitle, "_precision"),
                                     ggplot2::autoplot(curves, "precision",
                                                       raw_curves = raw_curves, ...))
  ...
  metrics7 <- c("sensitivity", "specificity",  "error", "accuracy", "precision",
               "mcc", "score")
  check_autoploat(curves, metrics7, "metrics7", raw_curves, ...)

  metrics6 <- c("sensitivity", "specificity",  "error", "accuracy", "precision",
               "mcc")
