...
#' The precrec package provides eight different \code{S3} generics for the
#'  \code{S3} objects generated by the \code{\link{evalmod}} function.
#'
#'   \tabular{lll}{
#'     \strong{\code{S3} generic}
#'     \tab \strong{Library} \tab \strong{Description} \cr
#'
...
#'     \code{\link{pauc}}     \tab precrec   \tab Make a data frame with pAUC scores
#'   }
#'
...
#' and partial AUC scores, respectively.
#'
#' @docType package
#' @name precrec
#'
