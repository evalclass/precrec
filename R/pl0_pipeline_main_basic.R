...
#
pl_main_basic <- function(mdat, calc_avg = TRUE, ci_alpha = 0.05,
                          all_curves = FALSE, x_bins = 1000,
                          orig_points = TRUE) {

  # === Validation ===
  .validate_pl_main_basic_args(mdat, calc_avg, ci_alpha, all_curves,
                               x_bins, orig_points)
...
#
# Validate arguments of pl_main_basic()
#
.validate_pl_main_basic_args <- function(mdat, calc_avg, ci_alpha, all_curves,
                                         x_bins, orig_points) {
