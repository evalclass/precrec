...
mmmdat <- mmdata(scores1, labels2, modnames = c("mod1", "mod2"),
                 dsids = c(1, 2))
```
...
mmmdat1 <- mmdata(scores1, labels2, modnames = c("mod1", "mod2"),
                  dsids = c(1, 2))
...
# Use column names
nfold_list2 <- format_nfold(nfold_df = M2N50F5,
...
```{r, fig.width=7, fig.show='hold'}
# mmdata
cvcurves2 <- mmdata(nfold_df = M2N50F5, score_cols = c(1, 2),
                    lab_col = 3, fold_col = 4,
                    modnames = c("m1", "m2"), dsids = 1:5)

# evalmod
cvcurves3 <- evalmod(nfold_df = M2N50F5, score_cols = c(1, 2),
                     lab_col = 3, fold_col = 4,
                     modnames = c("m1", "m2"), dsids = 1:5)
autoplot(cvcurves3)
```
