...
The Brier score and the log loss measure how close predicted probabilities are
to the observed labels. Unlike ROC and precision-recall curves, they read the
values of the scores rather than their ranks, so the scores must be
...
# Calculate the Brier score and the log loss
