...
### S3 generics
The `precrec` package provides six S3 generics for the S3 object 
...
### S3 generics
All the six S3 generics offered by this package are also effective for the S3 object generated by this approach.
```{r, fig.width=7, fig.show='hold'}
...
### S3 generics
All the six S3 generics except for the `auc` function are also effective 
